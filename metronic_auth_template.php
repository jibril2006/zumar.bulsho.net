...
function render_metronic_auth_page($mainContent, $templatePath, $pageTitle = null)
{
    ...
    $authStyles = '<style>'
        ...
        . 'background-image:linear-gradient(180deg,rgba(11,61,56,.78),rgba(15,118,110,.62)),url("' . $bgLight . '");'
        . 'background-position:center;'
        . 'background-repeat:no-repeat;'
        . 'background-size:cover;'
        . 'min-height:100vh;'
        . '}'
        . '.dark .page-bg{background-color:#0b3d38;background-image:linear-gradient(180deg,rgba(11,61,56,.86),rgba(15,118,110,.7)),url("' . $bgDark . '")}'
        . '.page-bg .kt-card{'
        . 'box-shadow:0 18px 48px rgba(11,61,56,.28);'
        ...
        . '.km-lang-switch--login{border:1px solid #d5e0dc;background:#f4f8f6;margin:0 auto .75rem}'
        . '.km-lang-switch--login a{color:#3f5f5b}'
        . '.km-lang-switch--login a.is-active{background:#0f766e;color:#fff}'
        . '.kt-btn-primary,.kt-btn.kt-btn-primary{background-color:#0f766e!important;border-color:#0f766e!important;color:#fff!important}'
        . '.kt-btn-primary:hover,.kt-btn.kt-btn-primary:hover{background-color:#115e59!important;border-color:#115e59!important}'
        . '.kt-link{color:#0f766e!important}'
        . '.kt-checkbox:checked,.kt-checkbox:checked:hover{background-color:#0f766e!important;border-color:#0f766e!important}'
        . '</style>';
