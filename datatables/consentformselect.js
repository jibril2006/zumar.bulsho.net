var ComponentsTypeahead = function () {
    ...
    var handleTwitterTypeahead = function() {
        ...
        var custom = new Bloodhound({
          ...
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          remote: {
            url: '../_data/survivorcontactdata.php?query=%QUERY',
            wildcard: '%QUERY'
          }
        });
        ...
        if (App.isRTL()) {
          $('#consentformselect_search').attr("dir", "rtl");  
        }  
        $('#consentformselect_search').typeahead(null, {
          name: 'daconsentformselect_search',
          displayKey: 'value',
            ...
            suggestion: Handlebars.compile([
              '<div class="media">',
                    ...
                    '<div class="media-body">',
                        '<h4 class="media-heading"><i class="fa fa-phone"></i>:&nbsp;{{value}}</h4>',
                        '<p>{{desc}}</p>',
                    '</div>',
              '</div>',
            ].join(''))
    ...
    var handleTwitterTypeaheadModal = function() {
        ...
        var custom = new Bloodhound({
          datumTokenizer: function(d) { return d.tokens; },
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          remote: '../_data/survivorcontactdata.php?query=%QUERY'
        });
