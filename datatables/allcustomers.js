var TableDatatablesButtons = function () {
    ...
    var initTable3 = function () {
        var table = $('#allcustomersdata');
        var recentMovers = String(table.data('recent-movers') || '0') === '1';
        ...
        var oTable = table.dataTable({
            ...
            "ajax": {
                    "url": "../_data/allcustomersdata.php", // ajax source
                },

            // setup responsive extension: http://datatables.net/extensions/responsive/
            responsive: false,
            columnDefs: [
                { targets: 0, className: "text-end km-col-house" },
                { targets: 1, className: "text-end km-col-kguri" },
                { targets: 2, className: "km-col-name" },
                { targets: 3, className: "km-col-phone" },
                { targets: 4, className: "text-end km-col-book" },
                { targets: 5, className: "text-end km-col-num" },
                { targets: 6, className: "text-end km-col-num" },
                { targets: 7, className: "text-end km-col-num" },
                { targets: 8, className: "text-end km-col-balance" },
                { targets: 9, orderable: false, className: "km-col-actions" },
        ...
        $('#allcustomersdata_tools > li > a.tool-action').on('click', function() {
