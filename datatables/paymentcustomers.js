var TableDatatablesButtons = function () {
    ...
    var initTable3 = function () {
        var table = $('#paymentcustomersdata');
        ...
        var oTable = table.dataTable({
            ...
            "serverSide": true,
            "ajax": {
                    "url": "../_data/paymentcustomersdata.php",
                },
        ...
        $('#paymentcustomersdata_tools > li > a.tool-action').on('click', function(e) {
            var action = $(this).attr('data-action');
            var dt = oTable.DataTable();
            // Excel (action 3): server-side export - no row limit
            if (action === '3') {
                e.preventDefault();
                window.location.href = '../_data/paymentcustomersexport.php';
                return;
            }
    ...
    var initAjaxDatatables = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "../_data/paymentcustomersdata.php", // ajax source
                },
                "order": [
                    [1, "asc"]
