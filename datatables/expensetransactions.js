var TableDatatablesButtons = function () {
    ...
    var initTable3 = function () {
        var table = $('#expensetransactionsdata');
        ...
        var oTable = table.dataTable({
            ...
            "ajax": {
                    "url": "../_data/expensetransactionsdata.php", // ajax source
                },
            ...
            columnDefs: [
                            ...
                            { width: "10%", targets: 1 },
                            { width: "12%", targets: 2 },
                            { width: "8%", targets: 3, className: "text-end" },
                            { width: "18%", targets: 4 },
                            { width: "11%", targets: 5, className: "text-end" },
                            { width: "10%", targets: 6, className: "text-end km-col-num" },
                            { width: "10%", targets: 7, className: "text-end km-col-num" },
                            { width: "12%", targets: 8, orderable: false, className: "km-col-actions" },
        ...
        $('#expensetransactionsdata_tools > li > a.tool-action').on('click', function() {
